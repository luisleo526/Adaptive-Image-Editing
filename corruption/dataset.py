...
class RGBAndDepthDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        depth_raw = numpy.load(depth_loc)
        depth_normalized = TF.to_tensor(depth_raw/depth_raw.max())
...
class RGBAndReshadeDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_loc = os.path.join(self.rgb_path, self.total_rgb_imgs[idx])
        reshade_loc = os.path.join(
            self.reshade_path, self.total_reshade_imgs[idx])
