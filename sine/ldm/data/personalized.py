...
#             text = random.choice(reg_templates_smallest).format(placeholder_string)
        ...
        text = random.choice(imagenet_dual_templates_small).format(self.placeholder_token, self.coarse_class_text)
...
class SinImageDataset(PersonalizedBase):
    def __init__(
        ...
        for _ in range(5):
            print("-"*30)
            print(random.choice(imagenet_dual_templates_small).format(self.placeholder_token, self.coarse_class_text))
...
class MultiImageDataset(Dataset):
    ...
    def __init__(
        ...
        assert len(data_root) == len(coarse_class_text)
        self.data_root = sum(data_root,[])
        self.coarse_class_text = {x:coarse_class_text[i] for i, y in enumerate(data_root) for x in y }
        ...
        for _ in range(10):
            print("-"*30)
            print(random.choice(imagenet_dual_templates_small).format(self.placeholder_token, random.choice(coarse_class_text)))
    ...
    def __getitem__(self, i):
        ...
        text = random.choice(imagenet_dual_templates_small).format(self.placeholder_token, self.coarse_class_text[image])
