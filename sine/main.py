...
#             now = os.path.basename(os.path.normpath(opt.data_root)) + now
    ...
    try:
        ...
        config.data.params.train.params.placeholder_token = opt.desc
        config.data.params.reg.params.placeholder_token = opt.desc
        config.data.params.validation.params.placeholder_token = opt.desc
        
        config.data.params.train.params.coarse_class_text = opt.obj
        config.data.params.reg.params.coarse_class_text = opt.obj
        config.data.params.validation.params.coarse_class_text = opt.obj
